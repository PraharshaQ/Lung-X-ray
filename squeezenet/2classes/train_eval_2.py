...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 11 17:23:07 2018
...
from model_2 import model as sq_model
from input_2 import input_from_csv
...
def model_fn(features, labels, mode, params):
    ...
    eval_metrics={"accuracy":tf.metrics.accuracy(labels=tf.argmax(labels,1),predictions=tf.argmax(logits,1))}
