...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 11 17:22:24 2018
...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep  6 12:01:52 2018
...
num_classes = 2
#writing feature column
#No need of feature column vector.SInce we already have only one feature column and it is in format of list
#sess=tf.Session()
#
#features,labels= sess.run(input_copy.input_from_csv("/home/praharsha/Desktop/RnD/Nvidia/chestXray_dataset/data.csv",1,16))
#features = tf.random_normal((16,256,256,1))
...
n_hidden_2 = 32
n_hidden_3 = 64
n_hidden_4 = 64                                                              # Easy to change while tuning
n_hidden_5 = 128
n_hidden_6 = 128
n_hidden_7 = 256
n_hidden_8 = 256
...
def model(x,is_training,reuse):
    ...
    with tf.contrib.slim.arg_scope([tf.contrib.slim.model_variable, tf.contrib.slim.variable], device="/cpu:0"):
        with tf.variable_scope('2D-Conv-1',reuse) as scope:
            ...
            #f_0 = max_pool(layer_1)
        f_1 = fire(layer_1, n_hidden_1, f_ind, is_training, reuse); f_ind += 1;
        f_2 = fire(f_1, n_hidden_2, f_ind, is_training, reuse); f_ind += 1;
        f_3 = fire(f_2, n_hidden_3, f_ind, is_training, reuse); f_ind += 1;            # Notice the reason for increment in f_ind
...
#pp = model(tf.random_normal((2,256,256,1)),is_training=True,reuse=tf.AUTO_REUSE)
